...
Create your own SListIterator which, again for simplicity, does not implement ListIterator. The only method in SList other than 
...
public class SList<T> {
    ...
    public static SListIterator<Object> iterator(){
